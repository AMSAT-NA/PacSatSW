 ...
 * ax5043.h
 *
 * TODO - things are not oranized in this way currently, but this is the plan
 * This include file should include settings that are generic to the AX5043
 * Settings and functions that are specific to the SPI implementation should be in ax5043_access.h
