 ...
 * which are not generated by or related to HalCoGen.
 */

/*
 * The code that raises privilege is located in FreeRTOS' port asm
 * module.  FreeRTOS does not use it but we will occasionally do that
 * here.
 */
